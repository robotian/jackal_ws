...
def generate_launch_description():
    ...
    # # Include Launch
    # ref_duro_node = GroupAction(
    #     actions=[            
    #         PushRosNamespace(LaunchConfiguration('reference_duro_namespace')),
    ...
    #             PythonLaunchDescriptionSource([duro_rear_launch]),  
    #             launch_arguments={(
    #                 'parameters'
    #                 ,
    #                 duro_rear_parameter
    ...
    odom_publisher_node = Node(
        ...
        parameters=[{'use_sim_time': LaunchConfiguration('use_sim_time')},     
                    ...
                    {'publish_tf': False}  # Local EKF will publish the tf      
                    ]
    )
    ...
    # ld.add_action(att_duro_imu_filter_node)
