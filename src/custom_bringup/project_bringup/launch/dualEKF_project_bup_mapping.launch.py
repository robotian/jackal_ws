...
def generate_launch_description():
    ...
    arg_zed_param = DeclareLaunchArgument(
        ...
        default_value=PathJoinSubstitution([
          ...
          'config',
          'dualEKF_rtabmap_zed_common.yaml'
        ]))
    ...
    launch_file_ekf_global = PathJoinSubstitution([
        pkg_project_bringup, 'launch', 'dualEKF_ekf_global.launch.py'])
    ...
    odom_heading_publisher_node = Node(
        ...
        executable='dual_gps_odom_publisher',  # The name of your Python script without the .py extension
        name='dual_gps_odom_publisher',
        output='screen',
        namespace=robot_namespace,
        # remappings=[('/tf','tf'),('/tf_static','tf_static') ],
        ...
        parameters=[
            ...
            {'front_odom_topic': 'sensors/gps_1/odom'},               
            {'rear_odom_topic': 'sensors/gps_2/odom'},               
            {'parent_frame_id': 'map'},               
            {'child_frame_id': 'odom'},               
            ]
    )
    ...
    # ld.add_action(odom_heading_publisher_node)
    return ld