...
class OdomTransformer(Node):
    def __init__(self):
        ...
        self.converting_odom_topic = 'zed_node/odom' # odom_zed --> camera_link
        self.converted_odom_topic  = 'odom'
        ...
        self.publisher = self.create_publisher(Odometry, self.converted_odom_topic, 10)
    ...
    def odom_callback(self, msg):
        ...
        try:
            ...
            T_odomZed_cam = transform_to_matrix([self.latest_odom.pose.pose.position.x , self.latest_odom.pose.pose.position.y, self.latest_odom.pose.pose.position.z], 
            ...
            T_odom_odomZed = transform_to_matrix([odom2odomZed_tf.transform.translation.x ,odom2odomZed_tf.transform.translation.y, odom2odomZed_tf.transform.translation.z],
                                             [odom2odomZed_tf.transform.rotation.x, odom2odomZed_tf.transform.rotation.y, odom2odomZed_tf.transform.rotation.z, odom2odomZed_tf.transform.rotation.w])
